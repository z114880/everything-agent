...
export const harnessPresentation: Record<string, { title: string; subtitle: string; x: number; y: number }> = {
  ...
  everything_md: { title: "EVERYTHING.md", subtitle: "System instructions", x: 24, y: 345 },
  ...
  consolidate_trigger: { title: "Consolidate", subtitle: "每日首次使用 / 手动触发", x: 24, y: 850 },
  consolidate_snapshot: { title: "全量事实与分批", subtitle: "Semantic Facts · 上下文预算", x: 244, y: 850 },
  consolidation: { title: "模型整理", subtitle: "去重 / 合并 / 冲突 / 清理", x: 464, y: 850 },
  consolidate_commit: { title: "校验并提交", subtitle: "版本检查 · 直接替换旧事实", x: 684, y: 850 },
  consolidate_result: { title: "整理结果", subtitle: "批次进度 / 冲突 / 错误", x: 904, y: 850 },
...
const connections = [
  ...
  ["procedural_memory", "working_memory", "程序性知识"],
