...
export const harnessPresentation: Record<string, { title: string; subtitle: string; x: number; y: number }> = {
  user_prompt: { title: "User Prompt", subtitle: "用户输入", x: 24, y: 135 },
  session_chat_history: { title: "Current Session", subtitle: "当前会话", x: 24, y: 240 },
  everything_md: { title: "EVERYTHING.md", subtitle: "用户常驻规则", x: 24, y: 345 },
  skills_catalog: { title: "Skills Catalog", subtitle: "Names & descriptions", x: 24, y: 460 },
  procedural_memory: { title: "Procedural Memory", subtitle: "Instructions + available skills", x: 244, y: 345 },
  system_prompt: { title: "System Prompt", subtitle: "系统提示词", x: 464, y: 345 },
  retrieval_gate: { title: "Retrieval Gate", subtitle: "小模型 · 代码验证检索意图", x: 244, y: 135 },
  semantic_recall: { title: "Semantic Recall", subtitle: "Semantic Memory", x: 464, y: 135 },
  ...
  memory_queue: { title: "记忆任务入队", subtitle: "manage_memory · 返回任务 ID", x: 244, y: 620 },
  consolidate_trigger: { title: "Consolidate", subtitle: "每日首次使用 / 手动触发", x: 24, y: 815 },
  consolidate_snapshot: { title: "全量事实与分批", subtitle: "Semantic Facts · 上下文预算", x: 244, y: 815 },
  consolidation: { title: "模型整理", subtitle: "去重 / 合并 / 冲突 / 清理", x: 464, y: 815 },
  consolidate_commit: { title: "校验并提交", subtitle: "版本检查 · 直接替换旧事实", x: 684, y: 815 },
  consolidate_result: { title: "整理结果", subtitle: "批次进度 / 冲突 / 错误", x: 904, y: 815 },
  memory_review: { title: "检索旧semantic memory", subtitle: "模型 · 合并 / 更新 / 忘记", x: 464, y: 675 },
  memory_commit: { title: "校验并保存", subtitle: "证据与版本校验 · 审计", x: 684, y: 675 },
  semantic_store: { title: "Semantic Memory", subtitle: "新增 / 更新 / 删除 / 合并 / 跳过", x: 904, y: 675 },
};
...
const connections = [
  ...
  ["system_prompt", "working_memory", "本轮系统指令"],
  ["tool_schemas", "working_memory", "工具接口"],
