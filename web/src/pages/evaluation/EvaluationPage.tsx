    ...
    <section className="eval-panel eval-launch" aria-label="数据集与实验">
      <header className="eval-panel-header">
        ...
        <div className="eval-panel-heading">
          ...
          {/* 平台侧步骤与本地启动同源，入口紧跟在说明后；需要时再展开，首屏不占位。 */}
          <div className="eval-panel-heading-actions">
            <AlertDialog>
              ...
              <AlertDialogContent className="eval-guide-dialog">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="eval-guide-note">按下面的顺序在 Langfuse 界面完成一次性配置，之后即可从数据集页直接触发本机评估；本地启动走左侧的 Run Experiment，不需要这些步骤。</AlertDialogDescription>
                </AlertDialogHeader>
